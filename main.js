...
- I need to check why the counting down is counting fast
- I need to return the timer to 25 when it reaches 0
- I need to add icons start and pause into the start button
- I need to finish setting up the other buttons
- testing
